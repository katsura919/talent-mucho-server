import { adminJsonSchema, createAdminJsonSchema, updateAdminJsonSchema, loginJsonSchema, loginResponseJsonSchema, } from "../../types/admin.types.js";
import { loginAdmin, getCurrentAdmin, createAdmin, getAllAdmins, getAdminById, updateAdmin, deleteAdmin, } from "./admin.controllers.js";
const adminRoutes = async (fastify) => {
    ...
    fastify.post("/admin/register", {
        schema: {
            description: "Register a new admin (first admin becomes super-admin, subsequent registrations require super-admin auth)",
            tags: ["Admin"],
    ...
    fastify.put("/admin/admins/:id", {
        preHandler: [fastify.requireSuperAdmin],
        schema: {
            description: "Update admin details including business assignments (super-admin only)",
            tags: ["Admin"],
            security: [{ bearerAuth: [] }],
            params: {
                type: "object",
