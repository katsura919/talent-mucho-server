...
const authAdminRoutes = async (fastify) => {
    // POST /admin/forgot-password
    fastify.post("/admin/forgot-password", {
        schema: {
            description: "Request an admin password reset. Sends a 6-digit code to the registered email address.",
            tags: ["Admin Auth"],
            body: {
                type: "object",
                required: ["email"],
    ...
    fastify.post("/admin/reset-password", {
        schema: {
            description: "Reset the admin password using the 6-digit code sent to their email.",
            tags: ["Admin Auth"],
            body: {
                type: "object",
