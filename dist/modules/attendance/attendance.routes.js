import { attendanceJsonSchema, clockInJsonSchema, clockOutJsonSchema, approveAttendanceJsonSchema, editAttendanceJsonSchema, } from "../../types/attendance.types.js";
import { clockIn, clockOut, getMyAttendance, getAllAttendance, getAttendanceByBusiness, getAttendanceByStaff, approveAttendance, editAttendance, deleteAttendance, } from "./attendance.controllers.js";
const attendanceRoutes = async (fastify) => {
    // ==================== STAFF ROUTES ====================
    // POST /attendance/clock-in - Staff clocks in
    fastify.post("/attendance/clock-in", {
    ...
    fastify.post("/attendance/clock-out", {
        preHandler: [fastify.authenticateStaff],
        schema: {
    ...
    fastify.get("/businesses/:businessId/attendance", {
        preHandler: [fastify.authenticate],
        schema: {
    ...
    fastify.get("/staff/:staffId/attendance", {
        preHandler: [fastify.authenticate],
        schema: {
    ...
    fastify.put("/attendance/:id/approve", {
        preHandler: [fastify.authenticate],
        schema: {
