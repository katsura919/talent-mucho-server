import { exchangeRateJsonSchema, upsertExchangeRateJsonSchema, } from "../../types/exchange-rate.types.js";
import { getExchangeRates, getExchangeRate, upsertExchangeRate, deleteExchangeRate, } from "./exchange-rate.controller.js";
const exchangeRateRoutes = async (fastify) => {
    ...
    fastify.get("/exchange-rates/:fromCurrency/:toCurrency", {
        preHandler: [fastify.authenticate],
        schema: {
    ...
    fastify.put("/exchange-rates", {
        preHandler: [fastify.authenticate],
        schema: {
            description: "Create or update an exchange rate (upserts by currency pair). Admin only.",
            tags: ["Exchange Rates"],
            security: [{ bearerAuth: [] }],
    ...
    fastify.delete("/exchange-rates/:fromCurrency/:toCurrency", {
        preHandler: [fastify.authenticate],
        schema: {
...
//# sourceMappingURL=exchange-rate.routes.js.map