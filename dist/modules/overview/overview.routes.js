import { getBusinessOverviewStats, getRecentBusinessInvoices, getRecentBusinessEods, } from "./overview.controller.js";
const overviewRoutes = async (fastify) => {
    fastify.get("/businesses/:businessId/overview/stats", {
    ...
    fastify.get("/businesses/:businessId/overview/recent-invoices", {
        preHandler: [fastify.authenticate],
        schema: {
            ...
            querystring: {
                ...
                properties: {
                    limit: {
                        type: "string",
                        description: "Max number of records to return (default 5, max 20)",
                    },
                },
            },
            response: {
    ...
    fastify.get("/businesses/:businessId/overview/recent-eods", {
        preHandler: [fastify.authenticate],
        schema: {
