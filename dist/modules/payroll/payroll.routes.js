import { payrollJsonSchema, generatePayrollJsonSchema, generateBusinessPayrollJsonSchema, approvePayrollJsonSchema, addAdjustmentJsonSchema, } from "../../types/payroll.types.js";
import { generatePayroll, generateBusinessPayroll, getPayrollById, getPayrollByStaff, getPayrollByBusiness, approvePayroll, markPayrollPaid, addPayrollAdjustment, deletePayroll, } from "./payroll.controllers.js";
const payrollRoutes = async (fastify) => {
    // ==================== PAYROLL GENERATION ====================
    ...
    fastify.post("/businesses/:businessId/payroll/generate", {
        preHandler: [fastify.authenticate],
        schema: {
    ...
    fastify.get("/staff/:staffId/payroll", {
        preHandler: [fastify.authenticate],
        schema: {
    ...
    fastify.get("/businesses/:businessId/payroll", {
        preHandler: [fastify.authenticate],
        schema: {
    ...
    fastify.post("/payroll/:id/adjustment", {
        preHandler: [fastify.authenticate],
        schema: {
