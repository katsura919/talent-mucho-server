...
import { updateStaffProfileSchema, addStaffDocumentSchema, } from "../../types/staff.types.js";
// Update staff profile (firstName, lastName, phone — no email)
export async function updateStaffProfile(request, reply) {
    ...
    await staffCol.updateOne({ _id: new ObjectId(id) }, {
        $set: {
            ...updates,
