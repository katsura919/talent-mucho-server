                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border: 1px solid #e4e4e7; border-radius: 8px; overflow: hidden; margin: 0 20px;">
                    <tr>
                        <td style="padding: 40px 40px 20px 40px;">
                            <h1 style="margin: 0 0 24px; font-size: 24px; font-weight: 600; color: #18181b;">Welcome to AVS Dashboard</h1>
                            ...
                            <p style="margin: 0 0 24px; font-size: 16px; line-height: 1.6; color: #52525b;">
                                An admin account has been created for you on the <strong>Advanced Virtual Staff</strong> dashboard. You have been assigned the role of <strong>${role}</strong>. Please log in using the credentials below and change your password immediately.
                            </p>
                            ...
                            <ul style="margin: 0 0 32px; padding: 0 0 0 20px; font-size: 15px; line-height: 1.6; color: #52525b;">
                                ...
                                <li>Start managing businesses and staff on the dashboard</li>
                            </ul>
...
//# sourceMappingURL=admin.creation.email.js.map