...
const staffInvoiceRoutes: FastifyPluginAsync = async (fastify) => {
  ...
  fastify.get<{
    ...
    "/invoices/me",
    {
      ...
      schema: {
        description:
          "Get current staff's invoices (only approved and paid invoices are visible)",
        tags: ["Invoices - Staff"],
        security: [{ bearerAuth: [] }],
        querystring: {
          type: "object",
  ...
  fastify.get<{ Params: { id: string } }>(
    "/invoices/me/:id",
    {
      ...
      schema: {
        description:
          "Get a specific invoice with EOD breakdown (own invoice, approved/paid only)",
        tags: ["Invoices - Staff"],
        security: [{ bearerAuth: [] }],
        params: {
          type: "object",
