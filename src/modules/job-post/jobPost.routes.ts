...
import {
    jobPostJsonSchema,
    createJobPostJsonSchema,
    updateJobPostJsonSchema,
...
} from "./jobPost.controllers.js";

const jobPostRoutes: FastifyPluginAsync = async (fastify) => {
    ...
    fastify.get<{ Querystring: { businessId?: string; status?: string } }>(
        "/job-posts",
        {
            ...
            schema: {
                description:
                    "Get all job posts with optional filters (requires authentication)",
                tags: ["Job Posts"],
                security: [{ bearerAuth: [] }],
                querystring: {
                    type: "object",
    ...
    fastify.patch<{ Params: { id: string } }>(
        "/job-posts/:id/status",
        {
            ...
            schema: {
                description:
                    "Change the status of a job post (requires authentication)",
                tags: ["Job Posts"],
                security: [{ bearerAuth: [] }],
                params: {
                    type: "object",
    ...
    fastify.get<{ Querystring: { businessId: string } }>(
        "/public/jobs",
        {
            schema: {
                description:
                    "List all open job posts for a specific business (public, no auth required)",
                tags: ["Public Jobs"],
                querystring: {
                    type: "object",
                    properties: {
    ...
    fastify.get<{ Params: { id: string } }>(
        "/public/jobs/:id",
        {
            schema: {
                description:
                    "Get a single open job post detail (public, no auth required)",
                tags: ["Public Jobs"],
                params: {
                    type: "object",
                    properties: {
