...
export type CreateCompensationProfileInput = z.infer<
  typeof createCompensationProfileSchema
>;
export type UpdateCompensationProfileInput = z.infer<
  typeof updateCompensationProfileSchema
>;
export type UpdateStaffStatutorySettingsInput = z.infer<
